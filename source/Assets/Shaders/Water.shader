Shader "Custom/Water" {
    ...
    SubShader {
        ...
        // To enable planar reflections, define these keywords and include
        // the file. If the probe is targeting ID 1, enable _PRID_ONE, if it's
        // targeting ID 2, enable _PRID_TWO and so on
        #define _PLANAR_REFLECTIONS_ENABLED
        #define _PRID_ONE
